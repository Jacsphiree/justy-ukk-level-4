...
<html>
<head>
 <title>Aplikasi Inventaris Sarana dan Prasarana Sekolah | Berbasis Web</title>
</head>
<body style="font-family:arial">
 <center><h2>Aplikasi Inventaris Sarana dan Prasarana Sekolah <br /> Berbasis Web</h2></center>
 <hr />
    ...
    <form name="update_user" method="post" action="ubah.php">
        <table border="0">
            ...
            <tr>
                ...
                <td><input type="text" size="50" name="koneksi_barang" value="<?php echo $kondisi_barang;?>"></td>
            </tr>
            <tr>
                <td>Keterangan</td>
